...
public class UrlPathConstants {
    ...
    public static final String COMMENT_REPORTS = "comment-reports";
    public static final String COMMENTS = "comments";
    public static final String IMAGES = "static.images";
    public static final String MAIL_AUTH = "mail-auth";
    public static final String ME = "me";
    public static final String NOTIFICATION = "notifications";
    public static final String POST_REPORTS = "post-reports";
    public static final String POSTS = "posts";
    public static final String PROFILE = "profile";
    public static final String RANKING = "ranking";
    public static final String SECTORS = "sectors";
    public static final String USER_REPORTS = "user-reports";
    public static final String USERS = "users";
    public static final String ZZANGS = "zzangs";
    ...
    public static final String COMMENT_REPORTS_PATH = PATH_DELIMITER + COMMENT_REPORTS;
    ...
    public static final String NOTIFICATION_PATH = PATH_DELIMITER + NOTIFICATION;
    public static final String POST_REPORTS_PATH = PATH_DELIMITER + POST_REPORTS;
    ...
    public static final String SECTORS_PATH = PATH_DELIMITER + SECTORS;
    public static final String USER_REPORTS_PATH = PATH_DELIMITER + USER_REPORTS;
    ...
    public static final String COMMENT_REPORTS_PATH_WITH_SLASH
        = COMMENT_REPORTS_PATH + PATH_DELIMITER;
    ...
    public static final String NOTIFICATION_PATH_WITH_SLASH = NOTIFICATION_PATH + PATH_DELIMITER;
    public static final String POST_REPORTS_PATH_WITH_SLASH = POST_REPORTS_PATH + PATH_DELIMITER;
    ...
    public static final String USER_REPORTS_PATH_WITH_SLASH = USER_REPORTS_PATH + PATH_DELIMITER;
