...
public class NotificationService {
    ...
    void notifyPostZzangNotification(Post post) {
        ...
        deleteBeforePostNotificationOfKeyword(post, receiver,
            NotificationContentMaker.KEYWORD_ZZANG);

        String zzangNotificationContent = NotificationContentMaker
            .makePressZzangNotificationContent(post);
    ...
    void notifyPostAddCommentNotification(Post post) {
        ...
        deleteBeforePostNotificationOfKeyword(post, receiver,
            NotificationContentMaker.KEYWORD_COMMENT);
    ...
    void notifyCommentZzangNotification(Comment comment) {
        ...
        deleteBeforeCommentNotificationOfKeyword(comment, receiver,
            NotificationContentMaker.KEYWORD_ZZANG);

        String zzangNotificationContent = NotificationContentMaker
            .makePressZzangNotificationContent(comment);
    ...
    void notifyCommentAddCommentNotification(Comment comment) {
        ...
        String zzangNotificationContent = NotificationContentMaker
            .makeCreatedCommentNotificationContent(comment);
        createNewCommentNotificationOfContent(comment, receiver, zzangNotificationContent);
    }
    ...
    void notifySectorApproved(Sector sector) {
        createNewSectorNotification(sector, NotificationContentMaker
            .makeApprovedSectorNotificationContent(sector));
    }
    ...
    void notifySectorRejected(Sector sector) {
        createNewSectorNotification(sector, NotificationContentMaker
            .makeRejectedSectorNotificationContent(sector));
    }

    @Transactional
    public void notifyGiveASectorCreatorAward(SectorCreatorAward sectorCreatorAward) {
        Notification notification = Notification.builder()
            .content(NotificationContentMaker.makeGivenAwardNotificationContent(sectorCreatorAward))
