...
public class CommentController {
    ...
    @PostMapping(
        UrlPathConstants.POSTS_PATH_WITH_SLASH + "{postId}" + UrlPathConstants.COMMENTS_PATH)
    public ResponseEntity<Void> createComment(@PathVariable Long postId,
        ...
        return ResponseEntity
            .created(
                URI.create(UrlPathConstants.COMMENTS_PATH_WITH_SLASH + commentResponse.getId()))
            .build();
    }

    @PostMapping(
        UrlPathConstants.POSTS_PATH_WITH_SLASH + "{postId}"
            + UrlPathConstants.COMMENTS_PATH_WITH_SLASH + "{commentId}"
            + UrlPathConstants.COMMENTS_PATH)
    ...
    @PutMapping(UrlPathConstants.COMMENTS_PATH_WITH_SLASH + "{commentId}")
    ...
    @GetMapping(UrlPathConstants.COMMENTS_PATH_WITH_SLASH + "{commentId}")
    ...
    @DeleteMapping(UrlPathConstants.COMMENTS_PATH_WITH_SLASH + "{commentId}")
    ...
    @PostMapping(
        UrlPathConstants.COMMENTS_PATH_WITH_SLASH + "{commentId}" + UrlPathConstants.ZZANGS_PATH)
