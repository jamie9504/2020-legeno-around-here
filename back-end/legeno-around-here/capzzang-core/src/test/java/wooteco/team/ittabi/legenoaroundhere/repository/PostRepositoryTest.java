...
public class PostRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        Area area = areaRepository.findById(AreaConstants.TEST_AREA_ID)
            .orElseThrow(() -> new NotExistsException("ID에 해당하는 Area가 없습니다."));
        User user = userRepository.findById(UserConstants.TEST_USER_ID)
        ...
        Post post = postRepository.save(Post.builder()
            ...
            .postImages(null)
            .sector(sector)
            .writing(PostConstants.TEST_POST_WRITING)
            .build());
        postId = post.getId();
    ...
    void findRankingBy_Success() {
        ...
        Assertions.assertThat(postsPage.getContent()).hasSize(1);
        Assertions.assertThat(postsPage.getTotalPages()).isEqualTo(1);
        Assertions.assertThat(postsPage.getTotalElements()).isEqualTo(1);
    }
    ...
    void findRankingBy_OverPage_ReturnEmptyPage() {
        ...
        Assertions.assertThat(postsPage.getContent()).hasSize(0);
        Assertions.assertThat(postsPage.getTotalPages()).isEqualTo(1);
        Assertions.assertThat(postsPage.getTotalElements()).isEqualTo(1);
    }
    ...
    void findRankingByAreaId_Success() {
        ...
        Page<Post> postsPage
            = postRepository
            .findRankingByAreaId(pageable, AreaConstants.TEST_AREA_ID, startDate, endDate);
    ...
    void findRankingByAreaIdAndSectorIds_Success() {
        ...
        Page<Post> postsPage = postRepository
            .findRankingByAreaIdAndSectorIds(pageable, AreaConstants.TEST_AREA_ID, sectorIds,
                startDate, endDate);
    ...
    void findRankingWithoutPaging_Success(
        ...
        Assertions.assertThat(posts).hasSize(expectedResultSize);
    }
    ...
    void findRankingByAreaIdWithoutPaging_Success(int maximumDataSize, int expectedResultSize) {
        ...
        List<Post> posts = postRepository
            .findRankingByAreaId(AreaConstants.TEST_AREA_ID, startDate, endDate, maximumDataSize);
    ...
    void findRankingByAreaIdAndSectorIdsWithoutPaging_Success(
        ...
        List<Post> posts = postRepository.findRankingByAreaIdAndSectorIds(
            AreaConstants.TEST_AREA_ID, sectorIds, startDate, endDate, maximumDataSize);
