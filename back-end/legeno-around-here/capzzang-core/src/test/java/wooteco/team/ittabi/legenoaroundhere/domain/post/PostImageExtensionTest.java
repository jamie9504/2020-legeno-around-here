...
public class PostImageExtensionTest {
    ...
    void validateImageExtension_NoneMatchImageExtension_ThrownException() throws IOException {
        MultipartFile multipartFile = TestConverterUtils
            .convert(
                ImageConstants.TEST_IMAGE_NOT_TXT_EXTENSION,
                ImageConstants.TEST_IMAGE_TEXT_CONTENT_TYPE);

        Assertions.assertThatThrownBy(() -> ImageExtension.validateImageExtension(multipartFile))
