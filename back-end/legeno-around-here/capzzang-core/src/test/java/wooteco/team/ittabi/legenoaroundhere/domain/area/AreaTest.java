...
class AreaTest {
    ...
    static {
        FIRST_DEPTH_AREA = Area.builder()
            .fullName(AreaConstants.TEST_AREA_FIRST_DEPTH_NAME)
        ...
        SECOND_DEPTH_AREA = Area.builder()
            .fullName(
                AreaConstants.TEST_AREA_FIRST_DEPTH_NAME + " "
                    + AreaConstants.TEST_AREA_SECOND_DEPTH_NAME)
            .firstDepthName(AreaConstants.TEST_AREA_FIRST_DEPTH_NAME)
        ...
        THIRD_DEPTH_AREA = Area.builder()
            .fullName(
                AreaConstants.TEST_AREA_FIRST_DEPTH_NAME + " "
                    + AreaConstants.TEST_AREA_SECOND_DEPTH_NAME + " "
                    + AreaConstants.TEST_AREA_THIRD_DEPTH_NAME)
            .firstDepthName(AreaConstants.TEST_AREA_FIRST_DEPTH_NAME)
            .secondDepthName(AreaConstants.TEST_AREA_SECOND_DEPTH_NAME)
        ...
        FOURTH_DEPTH_AREA = Area.builder()
            .fullName(
                AreaConstants.TEST_AREA_FIRST_DEPTH_NAME + " "
                    + AreaConstants.TEST_AREA_SECOND_DEPTH_NAME + " "
                    + AreaConstants.TEST_AREA_THIRD_DEPTH_NAME + " "
                    + AreaConstants.TEST_AREA_FOURTH_DEPTH_NAME)
            .firstDepthName(AreaConstants.TEST_AREA_FIRST_DEPTH_NAME)
            .secondDepthName(AreaConstants.TEST_AREA_SECOND_DEPTH_NAME)
            .thirdDepthName(AreaConstants.TEST_AREA_THIRD_DEPTH_NAME)
    ...
    void getLastDepthName_ExistsFirstDepthName_FirstDepthName() {
        assertThat(FIRST_DEPTH_AREA.getLastDepthName()).isEqualTo(
            AreaConstants.TEST_AREA_FIRST_DEPTH_NAME);
    }
    ...
    void getLastDepthName_ExistsSecondDepthName_SecondDepthName() {
        assertThat(SECOND_DEPTH_AREA.getLastDepthName()).isEqualTo(
            AreaConstants.TEST_AREA_SECOND_DEPTH_NAME);
    }
    ...
    void getLastDepthName_ExistsThirdDepthName_ThirdDepthName() {
        assertThat(THIRD_DEPTH_AREA.getLastDepthName()).isEqualTo(
            AreaConstants.TEST_AREA_THIRD_DEPTH_NAME);
    }
    ...
    void getLastDepthName_ExistsFourthDepthName_FourthDepthName() {
        assertThat(FOURTH_DEPTH_AREA.getLastDepthName()).isEqualTo(
            AreaConstants.TEST_AREA_FOURTH_DEPTH_NAME);
    }
}
